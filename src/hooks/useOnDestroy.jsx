...
const useOnDestroy = () => {
  const { removeContact,newOutboundContact, setNewOutboundContact } = useConnect();
  ...
  return (contact) => {
    ...
    const result = processOnDestroy(contact, agentName, newOutboundContact, setNewOutboundContact);
